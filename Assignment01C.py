...
# Winter 2024
# Assignment 01C - Socket Program Client
# Essmer Sanchez
# Worked With Class
...
def get_host_info():
    ...
    print("The Port Number is", port_num, "The Type is", pt)


# [2] Define a function binary_address() to convert your IP Address from “dotted decimal notation” to a 32-bit binary string.
# First, split the dotted decimal notation into four numbers, then find the binary equivalent of each and concatenate them
# back together. Be sure to remove the "0b" prefix of the binary numbers and to pad each component to 8 binary digits.
# When you are done, your binary address should be exactly 32 characters long.
...
def main():
    ...
    connect_to_server_v2("172.26.32.1", 12345)
