...
def main():
    ...
    print("huffman coding examples from slides", dc_huffman_coding(alphabet, freqs))

    # see figure 8.7 on slide 8.2
    text = "BBAB*"
    alphabet = ["A", "B", "*"]
    freqs = [.4, .5, .1]
    print("arithmetic_coding examples from slides", dc_arithmetic_coding(text, alphabet, freqs))
