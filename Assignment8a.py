...
# [4]  Write a function distance(x, y), defined as sqrt[(x[0] - y[0])2 + (x[1] - y[1])2 + … + (x[n-1] - y[n-1])2] where
# n is the length of x and y. Use a for-loop. You will need the sqrt function, so “import math” at the beginning of your code.
def distance(x,y):
